...
import { Codec, fixedBytes } from "./codec.js";
import {
  Uint128,
  Uint16,
  Uint256,
...
export const Byte32: Codec<BytesLike> = fixedBytes({
  byteLength: 32,
  encode: (value) => {
    return bytesFrom(value);
  },
...
export const HashType = fixedBytes<HashTypeLike>({
  byteLength: 1,
...
export const DepType = fixedBytes<DepTypeLike>({
  byteLength: 1,
