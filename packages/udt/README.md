...
Check the [package documentation](https://docs.ckbccc.com/en/docs/packages/protocol-sdks/udt) and [API reference](https://api.ckbccc.com/classes/_ckb-ccc_udt.udt) for more details.
