...
<Callout type="info">
  OKX 目前只支持比特币主网，不支持测试网和 Signet。详见 [OKX 官方公告](https://www.okx.com/zh-hans/help/okx-wallet-to-cease-support-for-the-btc-testnet)。
</Callout>
...
你可能还想探索以下 Wiki 页面：
- [CCC: Overview and Architecture (ckb-devrel/ccc)](https://deepwiki.com/ckb-devrel/ccc)