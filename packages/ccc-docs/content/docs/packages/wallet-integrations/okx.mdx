...
<Callout type="warning">
  OKX only supports Bitcoin mainnet. Testnet and signet are not available. See [the announcement](https://www.okx.com/help/okx-wallet-to-cease-support-for-the-btc-testnet) for details.
</Callout>
