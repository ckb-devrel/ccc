...
<div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
  ...
  <a href="https://www.npmjs.com/package/@ckb-ccc/core" target="_blank" rel="noopener noreferrer">
    <img src="https://img.shields.io/npm/v/%40ckb-ccc%2Fcore" alt="NPM Version" style={{ marginTop: '-0.5rem', marginBottom: '-0.5rem' }} />
  </a>
</div>
