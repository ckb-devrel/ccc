...
```typescript title="transfer.ts" theme={null}
import { ccc } from "@ckb-ccc/connector-react";
...
- Check the [Installation](./installation.mdx) guide for all package options and TypeScript configuration.
- Open the [CCC Playground](https://live.ckbccc.com/) to experiment with live examples in your browser.
- Browse the [API Reference](https://api.ckbccc.com) for the full list of available types and methods.
