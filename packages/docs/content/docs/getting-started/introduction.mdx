...
<Cards cols={2}>
  ...
  <Card title="Building with an AI assistant?" icon={<Bot />} href="../ai-resources">
    Point Cursor, Claude Code, Copilot, or Windsurf at CCC's docs in under 2 minutes so they stop guessing at CKB APIs.
  </Card>
</Cards>