...
> **For AI agents:** > **For AI Agents:** 本页面渲染的是交互式示例卡片，卡片内容无法直接作为文本读取。每个示例条目均包含一个 `source` 字段，其值为可直接访问的 GitHub raw URL，指向示例对应的 TypeScript 源码文件。如需查看某个示例的源码，直接 fetch 其 `source` URL 即可。如需浏览全部示例，请 fetch 本页面的 Markdown 版本 `https://docs.ckbccc.com/cn/docs/code-examples.md`，从 `<ExampleGrid />` 组件的 `items` 数组中提取各条目的 `source` 字段。
...
<ExampleGrid lang="zh" items={[
  ...
  },
  {
    ...
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/IssueXUdtSus/page.tsx",
  },
  {
    ...
    tags: ["app", "transaction", "udt"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/IssueXUdtTypeId/page.tsx",
  },
  {
    ...
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/CreateSporeCluster/page.tsx",
  },
  {
    title: "铸造 Spore",
    ...
    tags: ["app", "transaction", "spore"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/MintSpore/page.tsx",
  },
  {
    title: "转移 / 销毁 Spore",
    ...
    tags: ["app", "transaction", "spore"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/TransferSpore/page.tsx",
  },
  {
    ...
    tags: ["app", "transaction", "spore"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/TransferSporeCluster/page.tsx",
  },
  {
    title: "时间锁转账",
    ...
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/TimeLockedTransfer/page.tsx",
  },
  {
    title: "SSRI 合约调用",
    ...
    tags: ["app", "transaction"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/SSRI/page.tsx",
  },
  {
    title: "转账 CKB（Lumos）",
    ...
    tags: ["app", "transaction"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/connected/(tools)/TransferLumos/page.tsx",
  },
  {
    title: "CKB 哈希计算器",
    ...
    tags: ["app", "tool"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/utils/(tools)/Hash/page.tsx",
  },
  {
    title: "助记词与密钥对生成器",
    ...
    tags: ["app", "tool"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/utils/(tools)/Mnemonic/page.tsx",
  },
  {
    title: "Keystore 解密器",
    ...
    tags: ["app", "tool"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/utils/(tools)/Keystore/page.tsx",
  },
  {
    title: "Dep Group 管理器",
    ...
    tags: ["app", "tool"],
    source: "https://raw.githubusercontent.com/ckb-devrel/ccc/refs/heads/master/packages/demo/src/app/utils/(tools)/DepGroup/page.tsx",
  },
]} />
