...
<Callout type="warning">
  OKX exposes Bitcoin mainnet and Signet signers. BTC Testnet is not listed because OKX discontinued its support. See [the announcement](https://www.okx.com/help/okx-wallet-to-cease-support-for-the-btc-testnet) for details.
</Callout>
