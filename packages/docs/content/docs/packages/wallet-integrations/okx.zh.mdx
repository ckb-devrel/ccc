...
| `btcSignet`    | bitcoinSignet | Signet | `this.providers.bitcoinSignet` |

<Callout type="warning">
  OKX 提供 Bitcoin 主网和 Signet Signer。由于 OKX 已停止支持 BTC Testnet，因此不再展示 BTC Testnet。详见[官方公告](https://www.okx.com/help/okx-wallet-to-cease-support-for-the-btc-testnet)。
</Callout>
