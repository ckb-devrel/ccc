...
import { ClientScriptProvider } from "../../udt/script-providers.js";
import { buildNetworkConfig, isMainnet } from "../../utils/network.js";
...
export async function initializeRgbppEnv(): Promise<{
  ...
  return {
    ...
    ckbRgbppUnlockSigner: new CkbRgbppUnlockSigner({
      ...
      btcDataSource: rgbppBtcWallet.btcDataSource,
