...
- [#498](https://github.com/ckb-devrel/ccc/pull/498) [`f456e26`](https://github.com/ckb-devrel/ccc/commit/f456e26ae3746d7bd6303f4afb661dfcdafa5b60) Thanks [@Hanssen0](https://github.com/Hanssen0)! - feat(ssri): add ownership-aware `new` and `open` APIs for JSON-RPC executors
