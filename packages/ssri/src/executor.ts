...
import { SSRIExecutorResult, SSRIExecutorWorkerInitializeOptions, TraceRecord } from "./types.js";
 ...
 */
  ...
  private invokeSSRIExecutorCommand(name: string, args?: unknown[]): Promise<unknown> {
    // Why use lock here?
