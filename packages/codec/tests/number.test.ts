...
test("test Uint64", (t) => {
  const num = ccc.numFrom("0xf1f2f3f4f5f6f7f8");
  ...
  t.truthy(Uint64.unpack(packedLE) === num);
  t.truthy(Uint64BE.unpack(packedBE) === num);
  t.throws(() => Uint64.pack(ccc.numFrom("0x12345678901234567890")));
  t.throws(() => Uint64.unpack(new ArrayBuffer(3)));
  t.throws(() => Uint64BE.pack(ccc.numFrom("0x12345678901234567890")));
...
test("test Uint128", (t) => {
  ...
  t.truthy(Uint128.unpack(packedLE) === num);
  t.truthy(Uint128BE.unpack(packedBE) === num);
});
...
test("test Uint256", (t) => {
  ...
  t.truthy(Uint256.unpack(packedLE) === num);
  t.truthy(Uint256BE.unpack(packedBE) === num);
});
...
test("test Uint512", (t) => {
  ...
  t.truthy(Uint512.unpack(packedLE) === num);
  t.truthy(Uint512BE.unpack(packedBE) === num);
});
